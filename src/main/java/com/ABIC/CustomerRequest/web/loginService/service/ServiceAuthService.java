package com.ABIC.CustomerRequest.web.loginService.service;

import com.ABIC.CustomerRequest.web.config.LdapAuthenticationManager;
...
import com.ABIC.CustomerRequest.web.loginService.repository.AdminRepository;
import com.ABIC.CustomerRequest.web.loginService.repository.UserRepository;
...
public class ServiceAuthService {
    ...
    @Autowired
    public ServiceAuthService(UserRepository userRepository, JWTUtil jwtUtil, LdapAuthenticationManager ldapAuthenticationManager, LdapTemplate ldapTemplate, AdminRepository adminRepository) {
