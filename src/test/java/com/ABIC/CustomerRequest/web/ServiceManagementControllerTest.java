...
public class ServiceManagementControllerTest {
    ...
    void testGetRequestByNumberFound() {
        ...
        // When
        ResponseEntity<Response<RequestDetailsDTO>> response = serviceManagementController.getRequestByNumber("REQ-100000");
    ...
    void testGetRequestByNumberNotFound() {
        ...
        // When
        ResponseEntity<Response<RequestDetailsDTO>> response = serviceManagementController.getRequestByNumber("REQ-000");
